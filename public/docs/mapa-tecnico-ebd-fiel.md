...
- `git add src/App.jsx src/App.css src/data/mapaTecnicoSistema.js scripts/gerar-mapa-tecnico.cjs package.json` — adiciona os arquivos desta atualização.
- `git commit -m "Atualiza mapa tecnico vivo do sistema"` — salva a atualização no Git.
