...
- `git add index.html public/manifest.webmanifest public/favicon.ico public/favicon.png public/apple-touch-icon.png public/preview-ebdfiel-app.png public/icons src/data/mapaTecnicoSistema.js public/docs/mapa-tecnico-ebd-fiel.md public/docs/mapa-tecnico-ebd-fiel.txt` — adiciona os arquivos de miniatura, ícones, PWA e mapa técnico desta atualização.
- `git commit -m "Corrige miniatura e icones do app"` — salva a atualização no Git.
