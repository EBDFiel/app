...
- `git add index.html public/manifest.webmanifest public/favicon.ico public/favicon.png public/apple-touch-icon.png public/preview-ebdfiel-whatsapp.jpg public/preview-ebdfiel-app.png public/icons src/data/mapaTecnicoSistema.js public/docs/mapa-tecnico-ebd-fiel.md public/docs/mapa-tecnico-ebd-fiel.txt` — adiciona os arquivos de miniatura reforçada para WhatsApp, ícones, PWA e mapa técnico desta atualização.
- `git commit -m "Reforca miniatura e icones do app"` — salva a atualização no Git.
...
Arquivo principal de estilos. Contém layout público, login, dashboard, menu mobile, administração, relatórios, aniversariantes e mapa técnico.
