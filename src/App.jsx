      ...
      <div className="tela-login tela-cadastro-enviado">
        <section className="painel-apresentacao painel-cadastro-enviado">
          ...
          <div className="apresentacao-texto">
            ...
            <p>
              O administrador vai conferir os dados da igreja e liberar o acesso à plataforma.
            </p>
          </div>
        </section>
              ...
              <div className="hero-copy">
                ...
                <div className="hero-stats">
                  <div className="stat">
                    ...
                    <div className="stat-label">{'Igrejas cadastradas'}</div>
                  </div>
                  <div className="stat">
            ...
            <div className="container">
              ...
              <div className="plans-grid">
                <article className="plan-card">
                  ...
                  <p>{'Para igrejas em fase de implantação.'}</p>
